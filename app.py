...
st.set_page_config(page_title="𓃥白六聖誕相片邊框生成器", page_icon="🎄", layout="wide")
...
DEFAULT_PHOTO_PATH = os.path.join(ASSETS_DIR, "FC299C9C-DA6D-4677-9E11-F3CE3182A041.jpg")
FONT_PATH = os.path.join(ASSETS_DIR, "NotoSansTC-Regular.ttf")

st.title("🎄𓃥白六聖誕相片邊框生成器")
st.caption("上傳照片或使用預設照片 → 預覽 → 下方控制鍵調整 → 套用邊框 → 自動顯示祝福")
...
if uploaded:
    ...
    user_img = Image.open(DEFAULT_PHOTO_PATH).convert("RGBA")
